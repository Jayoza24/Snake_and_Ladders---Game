    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            className="font-content text-base text-black cursor-pointer tracking-widest font-bold py-2 px-4 rounded-full shadow-lg transition-all drop-shadow-2xl duration-500 bg-gradient-to-r from-[#fdfcfb] to-[#e2d1c3] bg-[length:200%_200%] bg-left hover:bg-right hover:scale-105"
